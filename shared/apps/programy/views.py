...
def pb_time(U: float, Th: float, Pb: float) -> float:
    ...
    # bezpečnostný limit iterácií (aby sa to nezaseklo pri divných vstupoch)
    for _ in range(2000):
...
def programy_home(request):
    ...
    return render(request, "programy/pb_time.html", {"form": form, "out": out, "err": err})
