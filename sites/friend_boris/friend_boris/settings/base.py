...
ROOT_URLCONF = "friend_boris.urls"
WSGI_APPLICATION = "friend_boris.wsgi.application"
ASGI_APPLICATION = "friend_boris.asgi.application"
...
STATIC_ROOT = REPO_ROOT / ".staticfiles" / "friend_boris"
STORAGES = {
    "default": {
...
SITE_BRAND = "Kamarát 2 – osobný web"
